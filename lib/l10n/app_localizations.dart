...
abstract class AppLocalizations {
  ...
  /// No description provided for @footer_favorites.
  ///
  /// In en, this message translates to:
  /// **'Favorites'**
  String get footer_favorites;
  ...
  /// In en, this message translates to:
  /// **'Cat breeds'**
  String get home_tittle;

  /// No description provided for @home_input_filter.
  ///
  /// In en, this message translates to:
  /// **'Filter by keyword'**
  ...
  ///
  /// In en, this message translates to:
  /// **'¿Do you have questions or concerns about this project?'**
  String get support_you_have_questions;
  ...
  String get support_contact_by_whatsApp;
}
